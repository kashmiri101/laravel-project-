      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            <img src="assets/img/logo-w.png" width="200px" class="pb-3" alt="" class="img-fluid">
            <p>
              A108 Adam Street <br>
    ...
    <div class="container footer-bottom clearfix">
      <div class="row">
        ...
        <div class="col-md-5 text-center">
          &copy; Copyright <strong><span>Evins Soltuion 2024</span></strong>. All Rights Reserved
        </div> 

        <div class="col-md-3 copyright footer-links">
